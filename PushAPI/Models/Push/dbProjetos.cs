...
{
    public partial class dbProjetos : DbContext
    {
        public dbProjetos()
        {
        }

        public dbProjetos(DbContextOptions<dbProjetos> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Perfil>(entity =>
            {
                ...
                entity.ToTable("Perfil", "SITE");

                entity.HasIndex(e => e.bE_Permissao_Geral, "IX_Perfil");
            ...
            modelBuilder.Entity<Solicitacao>(entity =>
            {
                ...
                entity.Property(e => e.Quantidade_Total_Restante).HasComputedColumnSql("([Quantidade_Total]-[Quantidade_Enviada])", false);
                ...
                entity.Property(e => e.idCurva_Envio_Dia_Normal).HasDefaultValueSql("((29))");
                ...
                entity.HasOne(d => d.idCurva_Envio_Dia_NormalNavigation)
                    .WithMany(p => p.SolicitacaoidCurva_Envio_Dia_NormalNavigation)
                    .HasForeignKey(d => d.idCurva_Envio_Dia_Normal)
                    .OnDelete(DeleteBehavior.ClientSetNull)
